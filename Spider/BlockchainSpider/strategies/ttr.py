...
class TTRBase(TTR):
    ...
    def __init__(
        ...
        super().__init__(source, alpha, beta, epsilon, device)
        self.p = dict()
        self.r = {source: 1.0}
        self._vis = set()
...
class TTRWeight(TTR):
    ...
    def __init__(self, source, alpha: float = 0.15, beta: float = 0.8, epsilon=1e-3, device: str = 'cpu'):
        super().__init__(source, alpha, beta, epsilon, device)
        self.p = dict()
        self.r = {source: 1.0}
        self._vis = set()
...
class TTRRedirect(TTR):
    ...
    def __init__(self, source, alpha: float = 0.15, beta: float = 0.8, epsilon=1e-3):
